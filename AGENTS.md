...
The completed P0-P3 corrective stack is being integrated through replacement PR #63 because the connected ready-for-review mutation for original draft PR #60 is broken by a connector GraphQL schema defect.

Exact #63 candidate: `461c2704586a8bcb5d876be30322cb19bff52a60`.

Fresh CI `33643641548` and Product Qualification `33643641313` must both PASS before exact-head merge.

After #63 lands, retirement branch `retirement/wbab-retirement-final` becomes the intended retirement-only delta against `main`.
