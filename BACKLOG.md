...
1. land retirement documentation/state against corrected `main`;
2. verify no release/image consumer remains;
3. disable unnecessary publication and optional workflows;
4. preserve useful lessons/evidence;
5. enter cooling-off and archive when #61 completion criteria are met.
