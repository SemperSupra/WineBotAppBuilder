...
mkdir -p "${TMP}/tools/WineBot/compose" "${TMP}/tools/WineBot/apps" "${TMP}/tools" "${TMP}/.wbab/signing/dev"
...
EOF
echo "dummy-cert" > "${TMP}/.wbab/signing/dev/dev.crt.pem"
...
export WBAB_DEV_CERT_DIR="${TMP}/.wbab/signing/dev"
